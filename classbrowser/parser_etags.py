...
class ETagsParserASP( ETagsParser ):
    ...
    def _get_type(self, string):
        ...
        if s.find("public function") >= 0: return "f"
        if s.find("private function") >= 0: return "f_priv"
        if s.find("function") >= 0: return "f"
        
        if s.find("public sub") >= 0: return "s_pub"
        if s.find("private sub") >= 0: return "s_priv"
        if s.find("sub") >= 0: return "s_pub"
